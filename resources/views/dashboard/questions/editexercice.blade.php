        ...
        <form id="employeeForm" method="post" action="{{ route('exercice.update',$exercice->id) }}">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <select class="form-control custom-select" id="course" name="course"
                        ...
                        @foreach ($courses as $course)
                            <option value="{{ $course->id }}" @if($course->id == $exercice->chapter->course->id) selected @endif>{{ $course->title }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group">
                ...
                <div class="buttons justify-content-end">
                    <a href="/exercice"><input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel"></a>
